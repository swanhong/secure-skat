...
analysis_dir <- dirname(normalizePath(script_path))
source(file.path(analysis_dir, "input.R"))
source(file.path(analysis_dir, "skat.R"))
...
# 4. Write gene-major CSV output for comparison with the secure results.
