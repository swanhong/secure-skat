...
var fedStageDefs = []fedStageDef{
	...
	{"manifest_sync", "secure_compute"},
	{"pre_block_setup", "secure_compute"},
	{"packed_weights", "secure_compute"},
	{"packed_raw_first_pass", "genes"},
	{"packed_exact_first_pass", "genes"},
	{"packed_hutch_first_pass", "genes"},
	{"packed_hutch_wave2", "genes"},
	...
	{"packed_finalize", "post_block_finalize"},
